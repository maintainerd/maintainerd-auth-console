...
// backend running. The login landing and static status routes render standalone
// (everything else lives under the authenticated `/:tenantId` layout), so we can
// assert on their accessibility without a live API.
const PORT = 4173
