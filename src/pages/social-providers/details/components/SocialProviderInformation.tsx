...
interface SocialProviderInformationProps {
  provider: {
    name: string
    identifier: string
    provider: string
...
export function SocialProviderInformation({ provider }: SocialProviderInformationProps) {
  return (
    <InformationCard title="Provider Information">
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-5">
        ...
        <div>
          ...
          <p className="text-sm">{getProviderDisplayName(provider.provider)}</p>
        </div>
        <div>
