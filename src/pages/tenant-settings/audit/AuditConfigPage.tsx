...
const LOG_LEVELS = [{ value: 'debug', label: 'Debug' }, { value: 'info', label: 'Info' }, { value: 'warn', label: 'Warn' }, { value: 'critical', label: 'Critical' }]
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-6">
        <div className="flex flex-col gap-2">
          ...
          <p className="text-muted-foreground">
            Configure audit logging behavior — retention period, PII masking, and log level.
          </p>
        </div>
