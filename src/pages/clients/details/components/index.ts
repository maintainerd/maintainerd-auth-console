 ...
 * Export all client detail page components
 */
...
export { ClientIdentityProviders } from './ClientIdentityProviders'
export { ClientRoles } from './ClientRoles'
export { AssignClientRolesDialog } from './AssignClientRolesDialog'
