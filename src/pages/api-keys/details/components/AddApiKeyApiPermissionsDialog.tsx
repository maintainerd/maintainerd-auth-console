...
import { useAddApiKeyApiPermissions } from "@/hooks/useApiKeys"
import { useToast } from "@/hooks/useToast"

interface AddApiKeyApiPermissionsDialogProps {
  open: boolean
...
export function AddApiKeyApiPermissionsDialog({
  open,
  onOpenChange,
  apiKeyId,
  apiId,
...
}: AddApiKeyApiPermissionsDialogProps) {
  ...
  const isLoading = addApiKeyApiPermissionsMutation.isPending

  // Filter out permissions that are already added to the API key API
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Select permissions to grant to this API key for the selected API.
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="space-y-3">
            ...
            <div className="border rounded-lg max-h-[400px] overflow-y-auto">
              ...
              {!isLoadingPermissions && availablePermissions.length === 0 && (
                <div className="text-center py-8 text-muted-foreground text-sm">
                  All permissions for this API have already been added to the API key
                </div>
              )}
