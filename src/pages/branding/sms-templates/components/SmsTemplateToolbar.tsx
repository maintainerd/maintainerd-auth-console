...
interface SmsTemplateToolbarProps {
  ...
  table: Table<SmsTemplate>
}

export function SmsTemplateToolbar({ 
  filter, 
  setFilter, 
  filters, 
  onFiltersChange, 
  table 
}: SmsTemplateToolbarProps) {
  ...
  const handleCreateTemplate = React.useCallback(() => {
    navigate(`/${tenantId}/branding/sms-templates/create`)
  }, [navigate, tenantId])
  ...
  return (
    <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
      <div className="flex flex-1 items-center gap-2">
        <Input
          placeholder="Search SMS templates by name..."
          value={searchInput}
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="flex flex-col gap-2">
                  {SMS_TEMPLATE_STATUSES.map((status) => (
