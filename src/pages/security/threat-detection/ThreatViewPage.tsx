...
export default function ThreatViewPage({ standalone = true }: { standalone?: boolean }) {
    ...
    <DetailsContainer>
      <div className="flex flex-col gap-6">
        <PageHeader
          ...
          description="Brute-force detection, anomaly monitoring, and security alert behaviors."
        />
        {content}
      </div>
    </DetailsContainer>
